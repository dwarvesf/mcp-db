...
let validatedConfigInstance = null;
// Helper function to parse alias=url pairs
function parseDatabaseUrls(inputs) {
    ...
    inputs.forEach((input, index) => {
        ...
        try {
            ...
            errors.push(`Invalid connection string URL for alias "${alias}": ${url} (${e.message})`);
            return;
        }
...
export function validateConfig(args) {
    ...
    const cliUrls = args['--database-urls'];
